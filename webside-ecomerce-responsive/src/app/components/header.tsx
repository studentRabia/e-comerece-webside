...
function Header() {
  ...
  return (
    <main className='border-b-2 bg-neutral-100'>
      <div className='bg-sky-200 w-full flex items-center justify-center b'>
        {/* all content */}
        <div className='sm:w-full md:w-[80%] flex items-center justify-between h-[50px]'>

          <div>
            {/* logo */}
            <h1 className='sm:text-3xl md:text-3xl lg:text-4xl xl:text-4xl font-bold ml-1 text-gray-950'>Exclusive</h1>
          </div>
          ...
          <div className='flex gap-x-4 items-center'>
            ...
            {/* Icons */}
            <FontAwesomeIcon icon={faHeart} className='text-2xl text-blue-950'></FontAwesomeIcon>
            <FontAwesomeIcon icon={faShoppingCart} className='text-blue-950 mr-1 text-2xl'></FontAwesomeIcon>
